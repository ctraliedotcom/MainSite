...
$\displaystyle d = u - u_{\text{ref}} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay308}%
$\displaystyle u_{\text{ref}} = f (\frac{b + X_{\text{ref}}}{Z_{\text{ref}}}) = f \frac{b}{Z_{\text{ref}}} + f \frac{X_{\text{ref}}}{Z_{\text{ref}}} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay310}%
$\displaystyle u = f (\frac{b + X}{Z}) = f \frac{b}{Z} + f \frac{X}{Z} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay312}%
$\displaystyle \frac{X}{X_{\text{ref}}} = \frac{Z}{Z_{\text{ref}}} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay314}%
$\displaystyle u = f \frac{b}{Z} + f \frac{X_{ref} \frac{Z}{Z_{\text{ref}}}}{Z} = f \frac{b}{Z} + f \frac{X_{\text{ref}}}{Z_{\text{ref}}}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay318}%
$\displaystyle d = u - u_{\text{ref}} = \frac{bf}{Z} - \frac{bf}{Z_{\text{ref}}}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay322}%
$\displaystyle Z = \frac{bf}{ \frac{bf}{Z_{\text{ref}}} - d} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle Z = \frac{bf}{d_{\text{off}} - d} $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
