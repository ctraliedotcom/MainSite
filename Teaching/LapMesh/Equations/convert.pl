...
#Purpose: To provide a pseudo "<latex>" tag in an html document, where Latex
#typesetting code for equations can be embedded into the document.  This
#uses a tool "dvi2png" to create images, and then links to those images
